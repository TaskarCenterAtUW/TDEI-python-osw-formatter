...
class Settings(BaseSettings):
    publishing_topic_name: str = os.environ.get('FORMATTER_TOPIC', None)
    subscription_topic_name: str = os.environ.get('FORMATTER_UPLOAD_TOPIC', None)
    subscription_name: str = 'test_subscription'
